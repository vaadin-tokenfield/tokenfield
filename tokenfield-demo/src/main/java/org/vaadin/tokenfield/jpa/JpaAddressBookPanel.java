 ...
 * Out-of-the-box support for such a container is not a goal of the add-on, so
 * an application over one has to resolve such captions itself, which is what
 * {@link TokenField#getTokenCaption(Object)} does here.
 * </p>
 */

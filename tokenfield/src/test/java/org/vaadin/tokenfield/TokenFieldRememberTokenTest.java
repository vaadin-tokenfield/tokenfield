...
class TokenFieldRememberTokenTest {
     ...
     * {@code setTokenCaption}, because setting a caption property switches the
     * field to {@code ItemCaptionMode.PROPERTY}, under which explicit captions
     * are not consulted. Overriding is what the class documentation points at
     * for captioning a new token anyway.
     * </p>
     */
